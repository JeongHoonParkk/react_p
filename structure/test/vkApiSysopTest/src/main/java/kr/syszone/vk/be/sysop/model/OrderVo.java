...
//	public OrderVo(Order aOrder, String otName, String ocName, String ecName, OrderDelivery od, Long pId,
//			String pName) {
...
//
//		this.fromName = od.getFromName();
//		this.fromAddressPost = od.getFromAddressPost();
//		this.fromAddressDetail = od.getFromAddressDetail();
//		this.fromLatitude = od.getFromLatitude();
//		this.fromLongitude = od.getFromLongitude();
//		this.toName = od.getToName();
//		this.toPostcode = od.getToPostcode();
//		this.toAddressPost = od.getToAddressPost();
//		this.toAddressDetail = od.getToAddressDetail();
//		this.toLatitude = od.getToLatitude();
//		this.toLongitude = od.getToLongitude();
//
//		this.productId = pId;
...
//	}
	...
	public OrderVo(Order aOrder, String otName, String ocName, String ecName, OrderDelivery aOd, Long pId,
			String pName) {
		this.id = aOrder.getId();
		this.name = aOrder.getName();
		this.orderType = aOrder.getOrderType();
	...
	public OrderVo(Order aOrder, String otName, String ocName, String ecName, Long pId, String pName) {
		this.id = aOrder.getId();
		this.name = aOrder.getName();
		this.orderType = aOrder.getOrderType();
		this.orderTypeName = otName;
